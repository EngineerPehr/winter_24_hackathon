            ...
            <div className="columns-2">
                <div className="break-after-column m-6">
                    <div className="pt-2">
                        ...
                        <p className="my-4">Workplace Wellness is a website designed to support individuals in achieving better sleep and overall well-being. Our platform combines evidence-based information and interactive tools to empower users on their sleep journey.</p>
                    </div>
                    ...
                    <div className="mt-5">
                        <h2 className="font-bold text-4xl">Recommended Daily Goals</h2>
                ...
                <div className="bg-accent-background border-accent-1 border-2 rounded-md mx-6 mt-6">
                    ...
                    <p className="ms-3 pb-10">Your Average Heart Rate: 87 bpm (Above Average)</p>
                </div>
            </div>
        )
    } else {
