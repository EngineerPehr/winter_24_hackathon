        ...
        <div>
            <div className="columns-2 mx-10 py-5">
                <div className="break-after-column m-6">
                    ...
                    <p>
                        At Workplace Wellness, we are dedicated to guiding you
                        on a journey towards improved sleep quality and enhanced
                        mental wellness. Our mission is to empower you with our
                        expertly curated articles, evidence-based tips, and
                        personalized strategies designed to help you unlock the
                        secrets to a restful night"s sleep. Whether you"re
                        dealing with stress, anxiety, insomnia, or simply
                        seeking to optimize your sleep routine, we are here to
                        provide a compassionate and informative space where you
                        can embark on your path to better sleep and mental
                        resilience.
                    </p>
                    <br />
                    <p>
                        Join our community of like-minded individuals who are
                        committed to prioritizing their mental health through
